...
/**
 * Support class for signaling to cadence which exception should NOT be retried. This is required because
 * {@link RetryOptions#getDoNotRetry()} supports only exception classes, not any details about those exceptions.
 * Generally use one of the wrapDoNotRetry functions with a lambda:
 * {@code DoNotRetrySupport.wrapDoNotRetry(() -> this.googleCloudStorage.deleteBucketRaw(bucketName))}
 */
