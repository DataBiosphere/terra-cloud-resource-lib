...
public abstract class CreateUserAssignedManagedIdentityRequestData extends BaseMsiRequestData {
    ...
    public final Optional<CloudResourceUid> resourceUidCreation() {
        // TODO: add along with Janitor support
    ...
    public abstract static class Builder {
        ...
        public abstract CreateUserAssignedManagedIdentityRequestData.Builder setSubscriptionId(String value);

        public abstract CreateUserAssignedManagedIdentityRequestData.Builder setResourceGroupName(String value);
