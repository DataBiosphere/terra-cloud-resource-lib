...
public class ResourcesReaderImpl implements ResourcesReader {
    ...
    public ResourcesReaderImpl(AzureResourceManager azureResourceManager, ResourceGroup resourceGroup) {
    ...
    public List<DeployedResource> listSharedResources() {
        return listResourceByTag(resourceGroup.name(),
    ...
    public List<DeployedVNet> listVNetWithSubnetPurpose(SubnetResourcePurpose purpose) {
        return listResourceByTag(resourceGroup.name(), purpose.toString(), null)
                .stream()
    ...
    private DeployedVNet toDeployedVNet(DeployedResource resource) {
        ...
        if (vNet == null) {
            logger.logExceptionAsError(
                    new RuntimeException("The resource provided is not VNet or the resource is no longer available"));
        }
