package bio.terra.cloudres.aws.notebooks;
...
public class SageMakerNotebooksCow {
  ...
  public static SageMakerNotebooksCow create(
      AwsSessionCredentials awsSessionCredentials, String location) {
  ...
  private NotebookInstanceSummary get(String instanceName)
    ...
    try {
      ...
      checkException(e);
      throw new RuntimeException("Error getting notebook instance", e);
    }
  }

  public void start(String instanceName) throws IllegalStateException, IOException {
    try {
      ...
      checkException(e);
      throw new RuntimeException("Error starting notebook instance", e);
    }
  }

  public void stop(String instanceName) throws IllegalStateException, IOException {
    try {
  ...
  private void pollForNotebookStatus(String instanceName, NotebookInstanceStatus status)
    ...
    throw new RuntimeException("Error checking notebook instance status");
  }
  ...
  public void checkNotebookStatus(String instanceName, Set<NotebookInstanceStatus> statusSet)
    ...
    try {
      ...
      throw new RuntimeException("Error checking notebook instance status", e);
    }
  }
  ...
  public void checkException(Exception ex) throws IllegalStateException, IOException {
    if (ex instanceof SdkException) {
      ...
      if (message.contains("not authorized to perform")) {
        ...
        throw new IllegalStateException("Unable to perform notebook operation on cloud platform");
      }
    }
  }
}
