...
public class MetricsHelper {
    ...
    private static final View LATENCY_VIEW = View.create(LATENCY_VIEW_NAME, "The distribution of latencies", LATENCY, latencyDistribution, Collections.unmodifiableList(Arrays.asList(KEY_LATENCY, KEY_CLOUD_API)));
    private static final View CLOUD_API_VIEW = View.create(API_VIEW_NAME, "The number of cloud api calls", API_COUNT, countAggregation, Collections.unmodifiableList(Arrays.asList(KEY_CLOUD_API, KEY_CLIENT)));
    private static final View ERROR_VIEW = View.create(ERROR_VIEW_NAME, "The distribution of line lengths", API_COUNT, countAggregation, Collections.unmodifiableList(Arrays.asList(KEY_ERROR, KEY_CLOUD_API, KEY_CLIENT)));
