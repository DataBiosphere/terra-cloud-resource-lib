...
public class GoogleCloudResourceManagerActivitiesImpl implements GoogleCloudResourceManagerActivities {
    private final GoogleCloudResourceManager googleCloudResourceManager;

    public GoogleCloudResourceManagerActivitiesImpl(GoogleCloudResourceManager googleCloudResourceManager) {
