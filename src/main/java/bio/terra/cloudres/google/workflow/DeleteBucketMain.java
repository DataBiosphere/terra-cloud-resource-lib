...
public class DeleteBucketMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        worker.registerActivitiesImplementations(new GoogleCloudStorageActivitiesImpl(new GoogleCloudStorage(ServiceAccountCredentials.fromStream(new FileInputStream(saKeyFile)))));
