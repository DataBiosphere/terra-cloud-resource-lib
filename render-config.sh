#!/bin/bash
# Render SA secrets used in CRL integration test. Those values are generated by Terraform and pulled from vault.
# TODO: Find a better solution to piping all configs.
