...
public class ServiceUsageCow {
    ...
    public ServiceUsageCow(
            ClientConfig clientConfig, ServiceUsage.Builder serviceUsageBuilder) {
    ...
    public class Services {
        ...
        public class BatchEnable extends AbstractRequestCow<Operation> {
            ...
            public BatchEnable(ServiceUsage.Services.BatchEnable batchEnable, BatchEnableServicesRequest content) {
                super(CloudOperation.GOOGLE_BATCH_ENABLE_SERVICES, clientConfig, operationAnnotator, batchEnable);
